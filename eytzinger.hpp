...
int isEytzinger(Data *a, Index length){
...
// template<typename Data, typename Index>
// void blockto_256(Data *a, Index n){
...
// void blocked_outshuffle_2(Data *a, Index n) {
// 	Index r = n % (2*B);
// 	Index m = n - r;
...
// 				// std::cout << j << " " << j + i << " " << edge << std::endl;
// 				// std::cout << i << std::endl;
// 			}
// 			std::rotate(a + j, a + j + i, a + edge);
// 			// for(int p = 0; p < n; p++){
// 			// 	std::cout << a[p] << " ";
// 			// }
// 			// std::cout << std::endl;
...
// template<typename Data, typename Index>
// void chunk(Data *a, Index n) {

// 	for(int i = 1; i < n - 1; i += 4){
// 		std::rotate(a + i, a + i + 1, a + i + 2);
// 	}
...
// template<typename Data, typename Index>
// int to_eyzinger_a(Data *a, Index n) {
...
// template<typename Data, typename Index>
// int to_eyzinger_blocked_2(Data *a, Index n) {
